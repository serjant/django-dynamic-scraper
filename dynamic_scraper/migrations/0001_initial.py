    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runtime_type', models.CharField(choices=[('S', 'SCRAPER'), ('C', 'CHECKER')], default='P', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attr_type', models.CharField(choices=[('S', 'STANDARD'), ('T', 'STANDARD (UPDATE)'), ('B', 'BASE'), ('U', 'DETAIL_PAGE_URL'), ('I', 'IMAGE')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('status', models.CharField(choices=[('A', 'ACTIVE'), ('M', 'MANUAL'), ('P', 'PAUSED'), ('I', 'INACTIVE')], default='P', help_text='Runtime status of the scraper, used by scheduling mechanism.', max_length=4)),
                ('work_status', models.CharField(choices=[('R2', 'REVISION NEEDED (MAJOR)'), ('R1', 'REVISION NEEDED (MINOR)'), ('UR', 'UNRESOLVED'), ('BR', 'BROKEN'), ('W', 'WORKING'), ('RC', 'RELEASE CANDIDATE'), ('BE', 'BETA'), ('A', 'ALPHA'), ('D', 'DRAFT'), ('S', 'SUSPENDED'), ('U', 'UNKNOWN'), ('N', 'NOT SET')], default='N', help_text='Internal work/progress status of the scraper.', max_length=4)),
                ...
                ('pagination_type', models.CharField(choices=[('N', 'NONE'), ('R', 'RANGE_FUNCT (+FOLLOW)'), ('F', 'FREE_LIST (+FOLLOW)'), ('O', 'FOLLOW')], default='N', max_length=4)),
                ...
                ('scraped_obj_class', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scrapedobjclass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(help_text='The different attributes to be scraped, exactly one attribute of type BASE necessary.', on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scrapedobjattr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scraper')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='obj_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scrapedobjclass'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('H', 'HTML'), ('X', 'XML'), ('J', 'JSON')], default='H', help_text='Data type format for scraped pages of page type (for JSON use JSONPath instead of XPath)', max_length=4)),
                ...
                ('request_type', models.CharField(choices=[('R', 'Request'), ('F', 'FormRequest')], default='R', help_text='Normal (typically GET) request (default) or form request (typically POST), using Scrapys corresponding request classes (not used for checker).', max_length=4)),
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(blank=True, help_text='Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scrapedobjattr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scraper')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mark_with_type', models.CharField(choices=[('PE', 'Planned Error'), ('DD', 'Dirty Data'), ('IM', 'Important'), ('IG', 'Ignore'), ('MI', 'Miscellaneous'), ('CU', 'Custom')], help_text='Choose "Custom" and enter your own type in the next field for a custom type', max_length=4)),
                ('custom_type', models.CharField(blank=True, max_length=25)),
                ('spider_name', models.CharField(blank=True, max_length=200)),
                ('scraper', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scraper')),
            ],
        ),
        migrations.CreateModel(
            name='Log',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('checker_type', models.CharField(choices=[('4', '404'), ('X', '404_OR_X_PATH')], default='4', max_length=4)),
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(help_text='Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.', on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scrapedobjattr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dynamic_scraper.scraper')),
            ],
        ),
    ]
