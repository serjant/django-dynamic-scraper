...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('runtime_type', models.CharField(default=b'P', max_length=4,choices=[(b'S', b'SCRAPER'), (b'C', b'CHECKER')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                (
                'status', models.CharField(default=b'P', max_length=4,choices=[(b'A', b'ACTIVE'), (b'M', b'MANUAL'), (b'P', b'PAUSED'), (b'I', b'INACTIVE')])),
                ('content_type', models.CharField(default=b'H', max_length=4,choices=[(b'H', b'HTML'), (b'X', b'XML')])),
                ...
                ('pagination_type', models.CharField(default=b'N', max_length=4,choices=[(b'N', b'NONE'), (b'R', b'RANGE_FUNCT'), (b'F', b'FREE_LIST')])),
                ...
                ('pagination_page_replace', models.TextField(
                    ...
                    blank=True)),
                ('checker_type', models.CharField(default=b'N', max_length=4,choices=[(b'N', b'NONE'), (b'4', b'404'), (b'X', b'404_OR_X_PATH')])),
