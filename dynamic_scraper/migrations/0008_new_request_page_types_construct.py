    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(default=b'H', help_text=b'Data type format for scraped pages of page type (for JSON use JSONPath instead of XPath)', max_length=2, choices=[(b'H', b'HTML'), (b'X', b'XML'), (b'J', b'JSON')])),
                ...
                ('request_type', models.CharField(default=b'R', help_text=b'Normal (typically GET) request (default) or form request (typically POST), using Scrapys corresponding request classes (not used for checker).', max_length=2, choices=[(b'R', b'Request'), (b'F', b'FormRequest')])),
