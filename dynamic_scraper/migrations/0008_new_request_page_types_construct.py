    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(default=b'R', help_text=b'Normal (typically GET) request (default) or form request (typically POST), using Scrapys corresponding request classes (not used for checker).', max_length=4,choices=[(b'R', b'Request'), (b'F', b'FormRequest')])),
                ...
                ('scraped_obj_attr', models.ForeignKey(blank=True, to='dynamic_scraper.ScrapedObjAttr', help_text=b'Empty for main page, attribute of type URL scraped from main page for detail pages.', null=True,on_delete=models.DO_NOTHING)),
        ...
        migrations.AddField(
            ...
            field=models.CharField(default=b'MP', max_length=4,choices=[(b'MP', b'Main Page'), (b'DP1', b'Detail Page 1'), (b'DP2', b'Detail Page 2'), (b'DP3', b'Detail Page 3'), (b'DP4', b'Detail Page 4'), (b'DP5', b'Detail Page 5'), (b'DP6', b'Detail Page 6'), (b'DP7', b'Detail Page 7'), (b'DP8', b'Detail Page 8'), (b'DP9', b'Detail Page 9'), (b'DP10', b'Detail Page 10'), (b'DP11', b'Detail Page 11'), (b'DP12', b'Detail Page 12'), (b'DP13', b'Detail Page 13'), (b'DP14', b'Detail Page 14'), (b'DP15', b'Detail Page 15'), (b'DP16', b'Detail Page 16'), (b'DP17', b'Detail Page 17'), (b'DP18', b'Detail Page 18'), (b'DP19', b'Detail Page 19'), (b'DP20', b'Detail Page 20'), (b'DP21', b'Detail Page 21'), (b'DP22', b'Detail Page 22'), (b'DP23', b'Detail Page 23'), (b'DP24', b'Detail Page 24'), (b'DP25', b'Detail Page 25')]),
        ),
        migrations.AddField(
            model_name='scraperelem',
            name='save_to_db',
